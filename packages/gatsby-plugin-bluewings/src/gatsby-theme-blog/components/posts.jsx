...
const Posts = ({ location, posts, siteTitle, socialLinks, pageContext }) => {
  return (
    <Layout location={location} title={getLocalText(siteTitle, pageContext)} indexPage={true} pageContext={pageContext}>
      <main>
        {posts.map(({ node }) => {
          ...
          return (
            <Fragment key={node.slug}>
              <SEO title="Home" keywords={keywords} pageContext={pageContext} />
              <div>
